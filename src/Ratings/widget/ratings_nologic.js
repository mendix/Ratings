...
define([
    ...
    return declare("Ratings.widget.ratings_nologic", [_WidgetBase], {
        ...
        displayImages : function (iterator) {
            console.debug(this.id + ".displayImages");
            var j, k;
        ...
        setRating : function(count) {
            var i;
            console.debug(this.id + ".onclickRating");
            this.newvalue = count;
        ...
        mouseleaveEvent : function(showVote, event) {
            console.debug(this.id + ".mouseleaveEvent");
...
require(["Ratings/widget/ratings_nologic"], function () {
    "use strict";
});